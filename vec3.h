...
class vec3 {
    ...
    public:
        ...
        __host__ __device__ vec3(double e0, double e1, double e2) : e{e0, e1, e2} {}        // initialize 3D vector with custom coordinates
    ...
    public:
        ...
        __host__ __device__ inline double operator[](int i) const { return e[i]; }                  // const index
        __host__ __device__ inline double& operator[](int i) { return e[i]; };                      // mutatable index
        ...
        __host__ __device__ inline vec3& operator/=(const vec3 &v2);                                // 
        __host__ __device__ inline vec3& operator*=(const double t);                                // self scalar multiplcation
        __host__ __device__ inline vec3& operator/=(const double t);                                // self scalar division
